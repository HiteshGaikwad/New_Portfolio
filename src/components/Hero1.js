...
const Hero1 = () => {
  return (
    <div className=" h-screen sm:bg-gradient-to-bl bg-gradient-to-b sm:pt-[5%] from-[#391e6f] from-10% to-50% to-black flex max-sm:flex-col sm:gap-2 md:gap-3 relative md:pl-20 md:pr-12 px-2">
      {/* left */}
      <div className=" sm:w-[55%] sm:h-[80%] md:h-[95%] md:gap-5 flex flex-col md:mt-20 mt-5">
        ...
        <div className="text-white text-lg w-full max-sm:mb-5 lg:w-[550px] md:font-extralight">
        ...
        <div className="flex max-sm:flex-col md:gap-4 gap-4 sm:items-center md:mt-8">
          <button className="border border-[#8750f7] rounded-full py-3 px-7 max-sm:w-52 md:py-4 md:px-9 text-[#8750f7] hover:bg-[#8750f7] hover:text-white transition-colors duration-500 ease-in-out">
            Download CV
          </button>
          ...
          <div className="flex md:gap-4">
            <ul className="flex gap-4">
              <li>
                <a href="#">
                  <TiSocialLinkedin className="text-4xl text-[#8750f7] border border-[#8750f7] p-[5px]  rounded-full" />
                </a>
              </li>
              <li>
                <a href="#">
                  <FaGithub className="text-4xl text-[#8750f7] border border-[#8750f7] p-[5px]  rounded-full" />
                </a>
              </li>
              <li>
                <a href="#">
                  <SiLeetcode className="text-4xl text-[#8750f7] border border-[#8750f7] p-[5px]  rounded-full" />
                </a>
              </li>
              <li>
                <a href="#">
                  <SiGeeksforgeeks className="text-4xl text-[#8750f7] border border-[#8750f7] p-[5px]  rounded-full" />
                </a>
              </li>
            </ul>
            {/* <img
